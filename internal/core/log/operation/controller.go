...
func mapEventKeyword(input string) (string, bool) {
	eventMap := map[string]string{
		...
		"calculate_score_single":      constant.EventCalculateScoreSingle,
		"calculate_score_bulk":        constant.EventCalculateScoreBulk,
		"download_history_single":     constant.EventDownloadScoreHistorySingle,
		"download_result_single":      constant.EventDownloadScoreHistoryBulk,
